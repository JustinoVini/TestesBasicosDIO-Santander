 ...
 * Ao ser ligada ao pneu, a bomba primeiro lê a pressão atual e calcula a diferença de pressão entre a
 * desejada e a lida. Com esta diferença ela esvazia ou enche o pneu para chegar na pressão correta.
 *
...
public class Pneu {
    public static void main(String[] args) {
        ...
        int lida = sc.nextInt();
        int resposta = (int) (desejada - lida);
